...
3. A Unified Model for Multi-class Anomaly Detection [PDF](https://arxiv.org/pdf/2206.03687)
4. FastRecon: Few-shot Industrial Anomaly Detection via Fast Feature Reconstruction (ICCV 2023) [PDF](https://openaccess.thecvf.com/content/ICCV2023/papers/Fang_FastRecon_Few-shot_Industrial_Anomaly_Detection_via_Fast_Feature_Reconstruction_ICCV_2023_paper.pdf)
5. PNI : Industrial Anomaly Detection using Position and Neighborhood Information (ICCV 2023) [PDF](https://openaccess.thecvf.com/content/ICCV2023/papers/Bae_PNI__Industrial_Anomaly_Detection_using_Position_and_Neighborhood_Information_ICCV_2023_paper.pdf)
6. Removing Anomalies as Noises for Industrial Defect Localization (ICCV 2023) [PDF](https://openaccess.thecvf.com/content/ICCV2023/papers/Lu_Removing_Anomalies_as_Noises_for_Industrial_Defect_Localization_ICCV_2023_paper.pdf)
7. Real-IAD: A Real-World Multi-View Dataset for Benchmarking Versatile Industrial Anomaly Detection (CVPR 2024) [PDF](https://openaccess.thecvf.com/content/CVPR2024/papers/Wang_Real-IAD_A_Real-World_Multi-View_Dataset_for_Benchmarking_Versatile_Industrial_Anomaly_CVPR_2024_paper.pdf)
8. Multimodal Industrial Anomaly Detection by Crossmodal Feature Mapping (CVPR 2024) [PDF](https://openaccess.thecvf.com/content/CVPR2024/papers/Costanzino_Multimodal_Industrial_Anomaly_Detection_by_Crossmodal_Feature_Mapping_CVPR_2024_paper.pdf)
9. 3D Industrial anomaly detection via dual reconstruction network [PDF](https://link.springer.com/article/10.1007/s10489-024-05700-x)
10. Dual-Branch Reconstruction Network for Industrial Anomaly Detection with RGB-D Data [PDF](https://arxiv.org/pdf/2311.06797)
11. Multimodal industrial anomaly detection via hybrid fusion (CVPR 2023) [PDF](https://openaccess.thecvf.com/content/CVPR2023/papers/Wang_Multimodal_Industrial_Anomaly_Detection_via_Hybrid_Fusion_CVPR_2023_paper.pdf)
12. Asymmetric Student-Teacher Networks for Industrial Anomaly Detection (WACV 2023) [PDF](https://openaccess.thecvf.com/content/WACV2023/papers/Rudolph_Asymmetric_Student-Teacher_Networks_for_Industrial_Anomaly_Detection_WACV_2023_paper.pdf)
13. Supervised Anomaly Detection for Complex Industrial Images (CVPR 2024) [PDF](https://openaccess.thecvf.com/content/CVPR2024/papers/Baitieva_Supervised_Anomaly_Detection_for_Complex_Industrial_Images_CVPR_2024_paper.pdf)
14. Text-Guided Variational Image Generation for Industrial Anomaly Detection and Segmentation (CVPR 2024) [PDF](https://openaccess.thecvf.com/content/CVPR2024/papers/Lee_Text-Guided_Variational_Image_Generation_for_Industrial_Anomaly_Detection_and_Segmentation_CVPR_2024_paper.pdf)
15.  RealNet: A Feature Selection Network with Realistic Synthetic Anomaly for Anomaly Detection (CVPR 2024) [PDF](https://openaccess.thecvf.com/content/CVPR2024/papers/Zhang_RealNet_A_Feature_Selection_Network_with_Realistic_Synthetic_Anomaly_for_CVPR_2024_paper.pdf)
16. Deep Industrial Image Anomaly Detection: A Survey [PDF](https://link.springer.com/article/10.1007/s11633-023-1459-z)
17. A Survey on Unsupervised Anomaly Detection Algorithms for Industrial Images [PDF](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10144292)
18. Feature Shrinkage Pyramid for Camouflaged Object Detection with Transformers (CVPR 2023) [PDF](https://openaccess.thecvf.com/content/CVPR2023/papers/Huang_Feature_Shrinkage_Pyramid_for_Camouflaged_Object_Detection_With_Transformers_CVPR_2023_paper.pdf)
